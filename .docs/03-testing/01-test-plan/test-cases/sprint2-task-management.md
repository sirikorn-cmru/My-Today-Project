...
| Test ID | Test Case Name | Pre-condition | Test Steps | Expected Result | Test Data | อ้างอิง (Requirement/AC) |
|---|---|---|---|---|---|---|
| TC-002-26 | Performance: การโต้ตอบ CRUD ของ Task (เพิ่ม/แก้ไข/ลบ/เปลี่ยนสถานะ/Filter/Sort) ตอบสนองภายในเกณฑ์ที่กำหนด (≤300ms) โดยไม่มี lag ที่มองเห็นได้ | ผู้ใช้เปิด My Today บนเครื่องคอมพิวเตอร์ทั่วไป (typical machine ตามที่ระบุใน test-plan.md § Non-Functional Requirements § Performance) ที่มี Task อยู่ในระบบแล้วอย่างน้อย 5 รายการ คละ Status/Priority/Life Area | 1. เปิดหน้า Tasks แล้วจับเวลา (stopwatch หรือสังเกตด้วยตา) ตั้งแต่กดปุ่ม "+ เพิ่มงาน" กรอกข้อมูลแล้วกดบันทึก จนถึง Task ใหม่ปรากฏในรายการ<br>2. กดแก้ไข Task 1 รายการ เปลี่ยนชื่องาน แล้วกดบันทึก จับเวลาจนค่าใหม่ปรากฏ<br>3. กดลบ Task 1 รายการ จับเวลาจนรายการหายไปจากหน้าจอ<br>4. กดปุ่ม/checkbox เปลี่ยนสถานะ Task 1 รายการ (เช่น To Do → Doing) จับเวลาจน badge สถานะเปลี่ยน<br>5. เลือก Filter ตาม Status หรือ Priority จับเวลาจนรายการที่แสดงกรองเสร็จ<br>6. เลือก Sort ตาม Deadline จับเวลาจนรายการเรียงลำดับใหม่เสร็จ | ทุกการโต้ตอบในขั้นตอน 1-6 (เพิ่ม/แก้ไข/ลบ/เปลี่ยนสถานะ/Filter/Sort) แสดงผลลัพธ์บนหน้าจอภายใน ≤300ms จากจังหวะที่กดปุ่ม/ยืนยัน ไม่มี lag ที่มองเห็นได้ระหว่างการคลิกกับ UI ที่อัปเดต | Task ที่มีอยู่แล้วในระบบ ≥5 รายการ คละ Status/Priority/Life Area; การกระทำที่ทดสอบ: เพิ่ม 1, แก้ไข 1, ลบ 1, เปลี่ยนสถานะ 1, Filter 1 ครั้ง, Sort 1 ครั้ง | [[../test-plan#Non-Functional Requirements\|test-plan.md — Non-Functional Requirements § Performance]] |

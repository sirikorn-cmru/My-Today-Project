...
Operation กลุ่มนี้ narrative ของ Sprint ที่ยังไม่เริ่ม (ตาม backlog.md ณ วันที่ 20260824 — Sprint 1-10 ทั้งหมด verified เสร็จแล้ว เหลือเฉพาะ Sprint 11 ที่ยังไม่มี commit ใดๆ) บอกเป็นนัยว่าจะต้องมี แต่ **ยังไม่ถูกสร้างจริงใน Domain Logic Layer ปัจจุบัน**:

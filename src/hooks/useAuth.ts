...
const AUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  // Firebase คืนรหัสนี้ทั้งกรณี "รหัสผ่านผิด" และ "ยังไม่มีบัญชีนี้" เมื่อโปรเจกต์เปิด
  // Email Enumeration Protection ไว้ (ค่าเริ่มต้นของโปรเจกต์ใหม่) — ตั้งใจไม่บอกว่าอีเมลไหน
  // มีบัญชีอยู่จริง เพื่อกันคนไล่เดาอีเมล ข้อความเดิมคือ "อีเมลหรือรหัสผ่านไม่ถูกต้อง"
  // ซึ่งอ่านแล้วเหมือนบัญชีมีอยู่แล้วแต่พิมพ์รหัสผิด ทำให้ผู้ใช้พยายามแก้รหัสผ่านวนอยู่
  // ทั้งที่ยังไม่เคยสมัครสำเร็จ จึงต้องพูดทั้งสองความเป็นไปได้ให้ชัด
  'auth/invalid-credential':
    'เข้าสู่ระบบไม่สำเร็จ — อีเมลนี้อาจยังไม่ได้สมัครสมาชิก หรือรหัสผ่านไม่ถูกต้อง',
